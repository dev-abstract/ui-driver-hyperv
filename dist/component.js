...
define("nodes/components/driver-hyperv/component", ["exports", "shared/mixins/node-driver"], function (exports, _nodeDriver) {
  "use strict";
  ...
  exports.default = Ember.Component.extend(_nodeDriver.default, {
    driverName: 'hyperv',
    config: alias('model.hypervConfig'),
    app: service(),
    init: function init() {
      var decodedLayout = window.atob(LAYOUT);
      var template = Ember.HTMLBars.compile(decodedLayout, {
        moduleName: 'nodes/components/driver-hyperv/template'
      });
    ...
    bootstrap: function bootstrap() {
      ...
      set(this, 'model.hypervConfig', config);
    },
...
define("ui/components/driver-hyperv/component", ["exports", "nodes/components/driver-hyperv/component"], function (exports, _component) {
  "use strict";
